...
from .views import index, home, register, user_login, user_logout, dashboard, process_image_feed, add_image_feed, delete_image
...
urlpatterns = [
    ...
    path('dashboard/index/', index, name='index'),
